import '../pages/css/InicioPage.css';
        ...
        <div className="d-flex flex-column bg-white">
            ...
            <section className="py-5 bg-hero">
                <div className="container text-center py-5">
                    {/* Mensaje de bienvenida personalizado para CANDIDATO */}
                    {user && user.rol === 'CANDIDATO' && (
                        <div className="mb-4 animate-fade-in">
                            <span className="badge bg-white text-primary px-3 py-2 rounded-pill shadow-sm mb-3">
                                👋 Hola {user.nombre}, ¡qué bueno verte de nuevo!
                            </span>
                        </div>
                    )}
